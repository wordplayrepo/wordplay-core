...
public interface Tile extends Comparable<Tile>
{
     ...
     *
     * @return <code>true</code> if a piece occupies this tile; <code>false</code>
     *         otherwise
     */
    public boolean hasPiece();

    /**
     * Retrieve the value of this tile taking into account only the value of a piece
     * on the tile. Attributes are not considered.
     *
     * @return the value
     */
    ...
    /**
     * Add the given collection of attributes to this tile that may affect the score
     * or gameplay.
     *
